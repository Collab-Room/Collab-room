        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column field="price" header="Member Count" :sortable="true" headerStyle="width:14%; min-width:8rem;">
                        <template>
                            <span class="p-column-title">Member Count</span>
                        </template>
                    </Column>
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                    ...
                    <div class="formgrid grid">
                        <div class="field col">
                            <label for="price">Menber Count</label>
                ...
                <Dialog v-model:visible="deleteProductsDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
                    <div class="flex align-items-center justify-content-center">
                        <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
                        <span v-if="product">Are you sure you want to delete the selected groups?</span>
                    </div>
                    <template #footer>
